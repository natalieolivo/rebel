                ...
                <div className="container masthead-container">
                    <div className="row">
                        ...
                        <div className="col-2 col-md-1 col-lg-2 col-xl-3 linkset-wrapper link-set-wrapper-flex">
                            ...
                            <a className="linkset-icon-link linkset-profile-icon-link" title="Account" href="" data-accounts-list-icon="">
                                <svg className="svg-icon profile-icon linkset-svg-profile" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 18.8">
                                    <path className="profile" fill="none" stroke="#848F91" d="M.5 14.8c.1-1.1 1-2.1 2.4-2.8.5.7 1.1 1.3 1.5 1.7.9.8 2.8 1.2 4 1.2s3.1-.4 4-1.2c.5-.5 1.2-1 1.7-1.6 1.4.7 2.2 1.7 2.3 2.7v3.4H.4l.1-3.4zm8-4c-3.6 0-4.6-4-4.6-6.2S5.9.5 8.5.5 13 2.3 13 4.6s-1 6.3-4.5 6.2z"></path>
                                </svg>
                            </a>
                            <a className="linkset-icon-link linkset-search-icon-link" href="/s" title="Search" aria-label="Go to the search page.">
                                <svg className="svg-icon search-icon linkset-svg-search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.9 19.7">
                                    <g className="search-icon-path" fill="none" stroke="#848F91">
                                        <path stroke-linecap="square" d="M18.5 18.3l-5.4-5.4"></path>
                                        <circle cx="8" cy="8" r="7"></circle>
                                    </g>
                                </svg>
                            </a>
                            <a className="linkset-icon-link" data-editions-list-icon="" href="">
                                <svg className="svg-icon globe-icon linkset-svg-globe" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <circle className="globe-water" fill="#FFF" cx="10" cy="10" r="9.5"></circle>
                                    <g className="globe-land-g" fill="#848F91">
                                    ...
                                    <path className="globe-inner-circle" fill="#FFF" d="M10 1.1c-4.9 0-8.9 4-8.9 8.9s4 8.9 8.9 8.9 8.9-4 8.9-8.9-4-8.9-8.9-8.9zm0 16.7c-4.3 0-7.8-3.5-7.8-7.8S5.7 2.2 10 2.2s7.8 3.5 7.8 7.8-3.5 7.8-7.8 7.8z"></path>
                                    <path className="globe-outer-circle" fill="#848F91" d="M10 20C4.5 20 0 15.5 0 10S4.5 0 10 0s10 4.5 10 10-4.5 10-10 10zm0-1.1c4.9 0 8.9-4 8.9-8.9s-4-8.9-8.9-8.9-8.9 4-8.9 8.9 4 8.9 8.9 8.9z"></path>
                                </svg>
                            </a>
                        </div>
